...
#
# 사용:  scripts/openshell_vm_up.sh [pharmasignal|nightshift|base]      (기본 pharmasignal)
# 환경변수(선택):
...
case "$POLICY" in pharmasignal|nightshift|base) ;; *) echo "정책은 pharmasignal | nightshift | base 중 하나" >&2; exit 2;; esac
